            ...
            <Modal open={open} onClose={onCloseModal} center>
                <div className="workshop-modal">
                    ...
                    <form onSubmit={handleSubmit(submitConference)} >
                        ...
                        <input type="text" name="name" id="name" placeholder="Enter the Title" value={topic} onChange={(e)=>{setTopic(e.target.value)}} required/><br/>
                        ...
                        <input type="text" name="name" id="name" placeholder="Enter the Venue" value={venue} onChange={(e)=>{setVenue(e.target.value)}}  required/><br/>
                        ...
                        <label id="icon" for="name"><i className="icon-user"></i></label>
                        <input type="text" name="name" id="name" placeholder="Organizers" value={organizer} onChange={(e)=>{setOrganizer(e.target.value)}}  required/><br/>
